...
const char * const BITCOIN_CONF_FILENAME = "elspero.conf";
const char * const BITCOIN_PID_FILENAME = "elspero.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/elspero";
#else
    // Unix
