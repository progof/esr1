...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1534410541, 2085002872, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa24a3b708d7f75d207c3e08f5c69a763d38230bf722433acea3d33223eae38ca"));
        ...
        vSeeds.emplace_back("dnsseed.elspero.org", true);
        //vSeeds.emplace_back("seed-a.elspero.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        //vSeeds.emplace_back("dnsseed.elsperotools.com", true);
        //vSeeds.emplace_back("dnsseed.elsperopool.org", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0xa24a3b708d7f75d207c3e08f5c69a763d38230bf722433acea3d33223eae38ca")},
...
*/
        ...
        chainTxData = ChainTxData{
            ...
            1534410541, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1534410526, 1118692, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x79b611d4d6b3014dee223499a9074deba198aea74fc96a9cdddf51963c09275a"));
        assert(genesis.hashMerkleRoot == uint256S("0x460ef86e8c4d83d7f41a33b3520ef6142a4b0e97910da625782dffcf73fe9ecd"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.elsperotools.com", true);
        vSeeds.emplace_back("seed-b.elspero.loshan.co.uk", true);
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xd3, 0x35, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0xd3, 0x35, 0x83, 0x94};
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("79b611d4d6b3014dee223499a9074deba198aea74fc96a9cdddf51963c09275a")},
            }
        };
